...
if [ ! -f .env ]; then
    ...
    echo ""
    echo "Example:"
    echo "BACKEND_URL=https://your-lambda-url.lambda-url.us-east-1.on.aws"
    echo ""
...
echo ""
echo "⚠️  IMPORTANT: Make sure your Lambda backend is running and accessible!"
echo ""
echo "Next steps:"
echo "  1. Ensure Lambda backend is running at: $BACKEND_URL"
